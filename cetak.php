...
if( empty( $_SESSION['iduser'] ) ){
   ...
   if(isset($_REQUEST['submit'])){
      ...
      $sql = mysqli_query($con, "SELECT s.nama,p.tgl_bayar,p.jumlah FROM siswa s INNER JOIN pembayaran p ON s.nis = p.nis AND p.nis='$nis'");
