...
if( empty( $_SESSION['iduser'] ) ){
	...
	if( isset( $_REQUEST['submit'] )){
		...
		$sql = mysqli_query($con, "UPDATE jenis_bayar SET jumlah='$jumlah' WHERE th_pelajaran='$tapel' AND tingkat='$tingkat'");
		...
		$sql = mysqli_query($con, "SELECT * FROM jenis_bayar WHERE th_pelajaran='$tapel' AND tingkat='$tingkat'");
